...
public class CommonProxy implements IGuiHandler{ //THIS IS IMPORTANT, CANNOT BE A PROXY/GUI HANDLER WITHOUT THIS!!
	...
	public void registerBlocks(){ //For registering Blocks
		...
		//Protection Block
		GameRegistry.registerBlock(ProtectionMod.protectionBlock, "ProtectionBlock");//Needed for all blocks
		LanguageRegistry.addName(ProtectionMod.protectionBlock, "Protection Block");//In-game name
	}
